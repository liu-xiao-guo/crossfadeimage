...
UBUNTU_TRANSLATION_DOMAIN="swipearea.liu-xiao-guo"
...
aptest.commands = bash $$PWD/swipearea/tests/autopilot/run
aptest.depends  = sub-swipearea

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/swipearea/tests/unit
unittest.depends  = sub-swipearea
